...
# Hique 
![Build Status](https://travis-ci.org/patriceperez/hique.svg?branch=master) ![Coverage Status](https://coveralls.io/repos/github/patriceperez/hique/badge.svg?branch=master)
